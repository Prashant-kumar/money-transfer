...
public class LedgerRecord extends UpdatableRecordImpl<LedgerRecord> implements Record4<UUID, UUID, Long, UUID> {
     ...
     */
    public LedgerRecord setTransactionId(UUID value) {
        set(3, value);
        return this;
    }
    ...
    @Override
    public Row4<UUID, UUID, Long, UUID> valuesRow() {
    ...
    @Override
    public LedgerRecord value4(UUID value) {
        setTransactionId(value);
        return this;
    }

    @Override
    public LedgerRecord values(UUID value1, UUID value2, Long value3, UUID value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public LedgerRecord(UUID uuid, UUID accountId, Long amount, UUID transactionId) {
        super(Ledger.LEDGER);

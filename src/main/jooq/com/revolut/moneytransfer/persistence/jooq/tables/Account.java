...
public class Account extends TableImpl<AccountRecord> {
    ...
    private static final long serialVersionUID = -1728715807;
     ...
     */
    public final TableField<AccountRecord, UUID> UUID = createField(DSL.name("UUID"), org.jooq.impl.SQLDataType.UUID.nullable(false), this, "");

    /**
     * The column <code>PUBLIC.ACCOUNT.NAME</code>.
     */
    public final TableField<AccountRecord, String> NAME = createField(DSL.name("NAME"), org.jooq.impl.SQLDataType.VARCHAR(64).nullable(false), this, "");
